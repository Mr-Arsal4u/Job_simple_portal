                                            ...
                                            <td>
                                                <div class="action-dots ">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="javascript:void(0)" onclick="deletejobType('{{ route('admin.job_types.destroy', $job_type->id) }}')"><i class="fa fa-trash" aria-hidden="true"></i> Remove</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
